...
public abstract class EnemyBase : CharacterBase
{
    ...
    //스탯
    protected float _attackDistance = 1.8f;
    protected float _sightRange = 8;
    ...
    protected Transform _targetCharacter;
    ...
    public void InitBase(RoamType roam, in Action onDestoryAction, List<Transform> posTF, int roamIndex, int enemyIndex)
    {
        ...
        _myPersonality = (EnemyPersonality)Random.Range(0, (int)EnemyPersonality.Max);
    ...
    protected abstract void AllZoneDisable();
